/* -------------------------------------------------------
 ...
 Theme Name: Beyond Leisure Tours - The Multipurpose HTML5 Template
 Theme URL: https://Beyond Leisure Tourshtml.themezaa.com/
 Description: Elevate your online presence with Beyond Leisure Tours - a modern, versatile, multipurpose Bootstrap 5 responsive HTML5, SCSS template using highly creative 52+ ready demos.
...
(function ($) {
    ...
    // Beyond Leisure Tours reveal box
    ...
    if (typeof $.fn.magnificPopup === 'function') {
        if ($('#subscribe-popup').length > 0) {
            let delaySecond = 1.5,
                    expireDays = 30,
                    cookieName = 'Beyond Leisure Tours-promo-popup';
    ...
    /* ===================================
     Beyond Leisure Tours progressive blur
     ====================================== */
    $(document).ready(function () {
        const blurContainer = $('.Beyond Leisure Tours-progressive-blur');
